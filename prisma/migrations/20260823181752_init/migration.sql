...
-- CreateEnum
CREATE TYPE "MessageRole" AS ENUM ('you', 'ai');
...
-- AddForeignKey
ALTER TABLE "Document" ADD CONSTRAINT "Document_adminId_fkey" FOREIGN KEY ("adminId") REFERENCES "User"("id") ON DELETE CASCADE ON UPDATE CASCADE;
